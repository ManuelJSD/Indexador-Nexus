...
public class AutoTilingService {
    ...
    /**
     * Detecta regiones contiguas de píxeles no transparentes en una imagen.
     * Utiliza un algoritmo de Flood Fill (BFS).
     *
    ...
    private Rectangle floodFill(PixelReader reader, BitSet visited, int width, int height, int startX, int startY) {
        int minX = startX;
        int maxX = startX;
        int minY = startY;
        int maxY = startY;
