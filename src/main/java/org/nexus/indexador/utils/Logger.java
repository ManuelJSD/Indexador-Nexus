...
/**
 * Clase de utilidad para el registro de mensajes (logging) de la aplicación. Permite registrar
 * mensajes de información, advertencia y error, con la posibilidad de guardarlos en un archivo de
 * registro y/o mostrarlos en la consola.
 */
public class Logger {
  ...
  private Logger() {
    ...
    log(Level.INFO,
        "Logger iniciado. Ruta de archivos de log: " + new File(logFilePath).getAbsolutePath());
  }
