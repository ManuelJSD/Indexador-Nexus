...
/**
 * Acción de modificación de un GRH.
 * Guarda el estado anterior para poder deshacerla.
 */
public class ModifyGrhAction implements UndoableAction {
     ...
     */
    public ModifyGrhAction(GrhData grh, int newFileNum, short newSX, short newSY,
